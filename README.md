...
|------------|---------|----------------|
| `01_streaming_to_silver` | [`auto_ingestion_layer/01_streaming_to_silver`](auto_ingestion_layer/01_streaming_to_silver.ipynb) | Streaming sales ingestion via **DLT**, saves to Silver layer |
